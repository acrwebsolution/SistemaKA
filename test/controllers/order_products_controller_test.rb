...
class OrderProductsControllerTest < ActionController::TestCase
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post :create, order_product: { cantidad: @order_product.cantidad, codcliente: @order_product.codcliente, codpedprod: @order_product.codpedprod, codproducto: @order_product.codproducto }
    end
  ...
  test "should update order_product" do
    patch :update, id: @order_product, order_product: { cantidad: @order_product.cantidad, codcliente: @order_product.codcliente, codpedprod: @order_product.codpedprod, codproducto: @order_product.codproducto }
    assert_redirected_to order_product_path(assigns(:order_product))
  end
