...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { codautor: @music.codautor, codgenero: @music.codgenero, codmusica: @music.codmusica, titulo: @music.titulo }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { codautor: @music.codautor, codgenero: @music.codgenero, codmusica: @music.codmusica, titulo: @music.titulo }
    assert_redirected_to music_path(assigns(:music))
  end
